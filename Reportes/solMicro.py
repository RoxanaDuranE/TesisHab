...
class SolicitudMicro(FPDF):
    ...
    def soliMicro(request, ids, idp):
        ...
        pdf.set_text_color(r,g,b)
        pdf.cell(w=50,h=5,txt='Género', border=1,  align='L', fill=0)
        pdf.set_text_color(0,0,0)
        ...
        pdf.set_text_color(0,0,0)
        pdf.cell(w=80,h=5,txt=per.IdOcupacion.Nombre if hasattr(per, 'IdOcupacion') else '', border=1,  align='L', fill=0)
        pdf.multi_cell(w=0,h=5,txt=dp.IdOcupacionFia.Nombre if hasattr(dp, 'IdOcupacionFia') else '', border=1,  align='L', fill=0)
        ...
        pdf.set_text_color(r,g,b)
        pdf.cell(w=50,h=5,txt='Teléfono', border=1,  align='L', fill=0)
        pdf.set_text_color(0,0,0)
        ...
        pdf.set_text_color(r,g,b)
        pdf.cell(w=50,h=5,txt='Teléfono de la microempresa', border=1,  align='L', fill=0)
        pdf.set_text_color(0,0,0)
        ...
        pdf.set_text_color(r,g,b)
        pdf.cell(w=70,h=5,txt='Dirección exacta de donde se construira', border=1,  align='L', fill=0)
        pdf.set_text_color(0,0,0)
