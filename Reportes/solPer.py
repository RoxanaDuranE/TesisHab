...
class solicitudPer(FPDF):
    ...
    def soliPer(request, ids):
        ...
        pdf.multi_cell(w=0,h=5,txt=dpf.IdOcupacionFia.Nombre if hasattr(dpf, 'IdOcupacionFia') else '', border=1,  align='L', fill=0)
        ...
        pdf.set_text_color(r,g,b)
        pdf.cell(w=50,h=5,txt='Teléfono del trabajo', border=1,  align='L', fill=0)
        pdf.set_text_color(0,0,0)
